...
type U = { h: string; un: string; name: string; state: string; water: "freshwater" | "saltwater" | "both"; exp: "new" | "casual" | "regular" | "serious"; bio: string; styles?: string[]; joined: number };

const USERS: U[] = [
  { h: "saltysam", un: "samdelgado", name: "Sam Delgado", state: "FL", water: "saltwater", exp: "serious", bio: "Tampa Bay flats rat. Reds, snook, and the occasional early-morning tarpon. Catch-and-release most days.", styles: ["boat", "kayak"], joined: 140 },
  { h: "reeldealrach", un: "rachelortiz", name: "Rachel Ortiz", state: "TX", water: "saltwater", exp: "regular", bio: "Wade fishing the Texas bays every chance I get. Trout and reds on soft plastics.", styles: ["shore", "kayak"], joined: 120 },
  { h: "basswhisperer", un: "dalehutchins", name: "Dale Hutchins", state: "MO", water: "freshwater", exp: "serious", bio: "20 years chasing largemouth on Ozark lakes. If it swims near a laydown, I've thrown at it.", styles: ["boat"], joined: 200 },
  { h: "kayakcarl", un: "carljensen", name: "Carl Jensen", state: "FL", water: "both", exp: "regular", bio: "Paddle-powered and proud. Mangroves, springs, and the flats, wherever the yak fits.", styles: ["kayak"], joined: 95 },
  { h: "driftandchill", un: "mboudreaux", name: "Marcus Boudreaux", state: "LA", water: "saltwater", exp: "casual", bio: "Louisiana marsh weekends. Slow drifts, cold drinks, redfish tails.", styles: ["boat"], joined: 60 },
  { h: "nautinancy", un: "nancykowalski", name: "Nancy Kowalski", state: "NC", water: "saltwater", exp: "regular", bio: "Outer Banks surf and a little nearshore. My trailer has more miles than my truck.", styles: ["surf", "boat"], joined: 110 },
  { h: "walleyewanda", un: "wandalindgren", name: "Wanda Lindgren", state: "MN", water: "freshwater", exp: "serious", bio: "10,000 lakes and I'm working through all of them. Jigging and live-bait rigs.", styles: ["boat"], joined: 180 },
  { h: "snooksniper", un: "dannyalvarez", name: "Danny Alvarez", state: "FL", water: "saltwater", exp: "serious", bio: "Night-tide bridge fanatic. Big linesiders or bust.", styles: ["shore", "boat"], joined: 130 },
  { h: "trollingtony", un: "tonymarchetti", name: "Tony Marchetti", state: "MI", water: "freshwater", exp: "regular", bio: "Great Lakes salmon and walleye. Boards, riggers, and lead core.", styles: ["boat"], joined: 150 },
  { h: "bluegillbill", un: "billhartman", name: "Bill Hartman", state: "OH", water: "freshwater", exp: "casual", bio: "Farm ponds and panfish with the grandkids. Simple gear, big smiles.", styles: ["shore"], joined: 75 },
  { h: "flatsfanatic", un: "evanwhitfield", name: "Evan Whitfield", state: "FL", water: "saltwater", exp: "serious", bio: "Poling skiff, tailing reds, and way too much tackle. Sight-fishing addict.", styles: ["boat"], joined: 160 },
  { h: "pierpete", un: "petenakamura", name: "Pete Nakamura", state: "CA", water: "saltwater", exp: "casual", bio: "SoCal pier regular. Halibut, bass, and whatever the bait ball brings in.", styles: ["pier"], joined: 50 },
  { h: "muskiemaggie", un: "maggiesorensen", name: "Maggie Sorensen", state: "WI", water: "freshwater", exp: "serious", bio: "The fish of 10,000 casts owes me nothing and I keep paying. Big baits, big net.", styles: ["boat"], joined: 175 },
  { h: "redfishrider", un: "jamalcarter", name: "Jamal Carter", state: "LA", water: "saltwater", exp: "regular", bio: "Sight-casting bronze backs in skinny marsh water. Gold spoon in my sleep.", styles: ["kayak", "boat"], joined: 100 },
  { h: "gonecoastal", un: "denisetillman", name: "Denise Tillman", state: "GA", water: "saltwater", exp: "casual", bio: "Georgia coast, live shrimp, and a popping cork. Keep it simple.", styles: ["boat"], joined: 45 },
  { h: "tightlinestim", un: "timrowley", name: "Tim Rowley", state: "SC", water: "both", exp: "regular", bio: "Lowcountry ponds during the week, inshore on weekends. Bass and reds keep me busy.", styles: ["shore", "boat"], joined: 90 },
  { h: "crappiecoach", un: "raydobbins", name: "Ray Dobbins", state: "TN", water: "freshwater", exp: "serious", bio: "Slabs are a science. Spider rigs, minnows, and brush piles are my classroom.", styles: ["boat"], joined: 165 },
  { h: "offshoreolivia", un: "oliviabrennan", name: "Olivia Brennan", state: "NJ", water: "saltwater", exp: "serious", bio: "Canyon runs and wreck fishing out of Jersey. Tuna, sea bass, and long boat rides.", styles: ["boat"], joined: 145 },
  { h: "newbienate", un: "natephillips", name: "Nate Phillips", state: "VA", water: "both", exp: "new", bio: "Six months in and hooked (pun intended). Learning something new every trip.", styles: ["shore"], joined: 30 },
  { h: "catfishcody", un: "codywheeler", name: "Cody Wheeler", state: "AL", water: "freshwater", exp: "regular", bio: "River cats after dark. Cut bait, stout rods, and a good headlamp.", styles: ["shore", "boat"], joined: 85 },
];
...
const ANSWERS: A[] = [
  ...
  { id: "da-04", q: "dq-02", author: "saltysam", helpful: 2, days: 4, body: "Also factor in how you'll load it solo. A 100 lb pedal yak is great on the water and miserable in the parking lot. If you're car-topping, weight matters more than you think." },
  ...
  { id: "da-08", q: "dq-04", author: "tightlinestim", helpful: 2, days: 10, body: "Shade and current. A little wind on a point or any moving water near cover will hold active fish even at 2pm. I've saved a lot of dead afternoons just relocating to the windy bank." },
  ...
  { id: "da-12", q: "dq-07", author: "driftandchill", days: 7, helpful: 2, body: "I went with a sealed 4000 in the $120 range and rinse it after every wade. Two seasons of abuse and it's still smooth. The sealing matters way more than the brand name at this price." },
  ...
  { id: "da-15", q: "dq-08", author: "kayakcarl", helpful: 3, days: 12, body: "One safety add: always tell someone your general area and launch time, and carry a paddle leash + whistle. The marsh all looks the same once the sun drops. Tide app on the phone is non-negotiable." },
  { id: "da-16", q: "dq-09", author: "trollingtony", days: 17, helpful: 2, body: "After demoing a few this season: an 8'6\"-9', heavy (not extra-heavy) rod with a moderate-fast taper saved my shoulder throwing glides all day. Enough tip to load the cast, enough butt to move the bait and drive the hooks. Extra-heavy pool cues wreck you by noon." },
  ...
  { id: "da-18", q: "dq-10", author: "tightlinestim", days: 6, helpful: 2, body: "A no-roll (flat) sinker on a slip rig holds current way better than an egg or round sinker that tumbles. Three-way works too if you want the bait up off the bottom. I'm running 2-4 oz depending on flow, enough to just hold, not anchor." },
  ...
  { id: "da-21", q: "dq-11", author: "snooksniper", helpful: 3, days: 18, body: "I went 23 and never regretted the extra foot the first time it snotted up 30 miles out. Fuel burn and slip fees go up though, factor the whole cost of ownership, not just the sticker." },
  { id: "da-22", q: "dq-12", author: "walleyewanda", days: 1, helpful: 3, body: "A small bobber, a #8 hook, and a piece of nightcrawler under a dock or over any brush = nonstop bluegill and zero tangles. Keeps kids busy for hours. Cut the worm small so the little fish can actually get it." },
  ...
  { id: "da-23b", q: "dq-13", author: "basswhisperer", days: 10, helpful: 2, body: "Once fish push shallow to stage, casting a 1/16 oz jig to cover out-fishes the spider rig for me, you can pick apart individual brush and stumps. I only go back to spider rigging when they're scattered and suspended out deeper." },
  ...
  { id: "da-25", q: "dq-14", author: "flatsfanatic", days: 5, helpful: 2, body: "A 3-4\" swimbait on a 1/2 oz jighead in anything sardine or anchovy colored is the classic pier producer for both. Bounce it slow along the bottom near the pilings. Same program we use for flounder down here, and grubs in root beer produce when the water clears." },
  ...
  { id: "da-32", q: "dq-18", author: "newbienate", helpful: 2, days: 3, body: "Saving this whole thread. I have been bombing casts way past the bar all summer, which apparently means casting right over the fish." },
];
...
async function main() {
  ...
  for (const u of USERS) {
    ...
    // realistic-username migration: never steal a handle from a real account
    const taken = await db.query.profiles.findFirst({ where: eq(profiles.username, u.un) });
    const username = taken && taken.userId !== id ? `${u.un}${Math.floor(Math.random() * 90) + 10}` : u.un;
    ...
    }).onConflictDoUpdate({ target: profiles.userId, set: { username, displayName: u.name, bio: u.bio } });
  }
  ...
  for (const q of QUESTIONS) {
    ...
    }).onConflictDoUpdate({ target: forumQuestions.id, set: { title: q.title, body: q.body } });
  }
  ...
  for (const a of ANSWERS) {
    ...
    }).onConflictDoUpdate({ target: forumAnswers.id, set: { body: a.body, userId: `demo-${a.author}` } });
  }
